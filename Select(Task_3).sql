...
SELECT DISTINCT Исполнители.Исполнитель_id, Исполнители.Имя
FROM Исполнители
LEFT JOIN ИсполнителиАльбомы ON Исполнители.Исполнитель_id = ИсполнителиАльбомы.Исполнитель_id
LEFT JOIN Альбомы ON ИсполнителиАльбомы.Альбом_id = Альбомы.Альбом_id
WHERE Альбомы.ГодВыпуска IS NULL OR Альбомы.ГодВыпуска != 2020;
